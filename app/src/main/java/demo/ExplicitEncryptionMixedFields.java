...
public class ExplicitEncryptionMixedFields {
    ...
    public static void main(String[] args) {
        ...
        try (ClientEncryption clientEncryption = ClientEncryptions.create(clientEncryptionSettings)) {
            ...
            EncryptOptions encryptValueOptions2 = new EncryptOptions("AEAD_AES_256_CBC_HMAC_SHA_512-Deterministic")
                    .keyId(dataKeyId2);
            ...
            try (MongoClient mongoClient = MongoClients.create(clientSettings)) {
                ...
                BsonDocument encryptedQuery2 =
                        new BsonDocument(ENCRYPTED_FIELD_2, encryptValue(clientEncryption, new BsonInt64(30L), encryptValueOptions2));
